...
const Footer = () => {
  ...
  <span className="footer-title">Address:</span> 
    <p>1100 Main Street,</p>
<p> Bonani, Dhaka, Bangladesh</p>
  </div>
  <div>
    <span className="footer-title">Contact Us:</span> 
    <p className='flex items-center justify-around'><FaPhoneAlt /> <span className='ml-2'>+1 346 456-7890 </span>
</p>
    <p className='flex items-center justify-around'><FaMailBulk /> <span className='ml-2'> info@yourwebsite.com </span>
</p>
    <p className='flex items-center justify-around'><FaWhatsapp /> <span className='ml-2'>01745465425 </span>
</p>
<p></p>
